...
class c_loop_base {
	public:
		...
		explicit c_loop_base(c_class &con) : nx(con.nx), ny(con.ny), nz(con.nz),
...
class c_loop_all_periodic : public c_loop_base {
	public:
		...
		template<class c_class>
		explicit c_loop_all_periodic(c_class &con) : c_loop_base(con), ey(con.ey), ez(con.ez), wy(con.wy), wz(con.wz),
